...
private:
     ...
     *
     * Passes execution stats from the trial period run of the cached plan to the plan cache.
     *
     ...
     *
     * Fallbacks to a new plan if the performance was worse than anticipated during the trial
     * period.
     *
